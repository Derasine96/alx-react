...
const notificationStyles = StyleSheet.create({
  ...
  hover: {
    ':hover': {
      cursor: 'pointer',
      animationName: [keyframes.opacityChange, keyframes.bounce],
    ...
    return (
      <React.Fragment>
        {!this.props.displayDrawer ? (
          <div className={css(notificationStyles.menuItem, notificationStyles.hover)} onClick={this.props.handleDisplayDrawer}>
